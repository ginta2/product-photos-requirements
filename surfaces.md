...
| Discover Hub — recommendation card (standard) | iOS / Android | ~1.3:1 | 390w × 300h (iPhone 14) | Yes | Bottom (gradient title overlay) | P1 | h=300pt | width=full-bleed | Discovery | `src/modules/social-recipe-bridge/components/cookbook-recommendations/recommendation-card/styles.ts` |
| Discover Hub — recommendation card (swipe/expanded) | iOS / Android | ~0.87:1 | 390w × 450h (iPhone 14) | Yes | Bottom (gradient title overlay) | P1 | h=450pt | width=full-bleed | Discovery | `src/modules/social-recipe-bridge/components/cookbook-recommendations/recommendation-card/styles.ts` |
