...
| Mobile Menu — "Your meals" preselected card (large) | Mobile (RN) | Dynamic (fluid width × 202h) | h=202 | Yes | Top-left (badge) + bottom-right (cart stepper) | P0 | h=202pt | width=container | Selection | `src/features/product-card-feature/variants/edit/components/EditLargeCard.tsx` (`size={{ height: 202 }}`) |
...
| Mobile Menu — "Your favourite recipes" carousel | Mobile (RN) | Fluid × 240h (favorite variant) | h=240 | Yes | Top-right (+ button) | P1 | h=240pt | width=container | Selection | `src/features/product-card-feature/variants/favorite/constants.ts:CARD_IMAGE_HEIGHT = 240` |
...
| Mobile Menu — Past Delivery card | Mobile (RN) | Fluid × 240h | h=240 | Yes | Top-left | P1 | h=240pt | width=container | Selection | `src/features/product-card-feature/variants/past-delivery/constants.ts:CARD_IMAGE_HEIGHT = 240` |
