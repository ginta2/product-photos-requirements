...
| Add-on / Food Item Carousel | iOS | ~5:7 (~0.68:0.95) | ~140×200 | No | — | P2 | both | — | Selection | `FoodItemCarousel/.../FoodItemsCarouselView.swift:74` |
...
| Cookbook — Recipe list item (collection detail) | iOS / Android | 1:1 | ~152×152 | No | — | P1 | both | — | Discovery | `src/modules/social-recipe-bridge/screens/collection-detail/components/recipe-list-item/styles.ts:13` |
| Cookbook — Collection card thumbnail (header) | iOS / Android | 2:1 wide | ~180×90 | No | — | P1 | both | — | Discovery | `src/modules/social-recipe-bridge/components/collections/collection-card/styles.ts:10` |
...
| Mobile Menu — "Your favourite recipes" carousel | iOS / Android | Fluid × 240h (favorite variant) | ~358×240 (iPhone 14) | Yes | Top-right (+ button) | P1 | h=240pt | width=container | Selection | `src/features/product-card-feature/variants/favorite/constants.ts:CARD_IMAGE_HEIGHT = 240` |
...
| Mobile Menu — Past Delivery card | iOS / Android | Fluid × 240h | ~358×240 (iPhone 14) | Yes | Top-left | P1 | h=240pt | width=container | Selection | `src/features/product-card-feature/variants/past-delivery/constants.ts:CARD_IMAGE_HEIGHT = 240` |
...
| Founder/Creator profile — recipe grid | iOS / Android | 1:1 (visual) | ~163×163 | Yes | Top-right (bookmark) | P2 | both | — | Discovery | TBD — code location not confirmed in audit |
